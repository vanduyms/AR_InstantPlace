...
public class HelloArActivity extends AppCompatActivity implements SampleRender.Renderer {
  ...
  public void onSurfaceCreated(SampleRender render) {
    ...
    try {
      ...
      // Create object to place on plane
      virtualObjectMesh = Mesh.createFromAsset(render, "models/image.obj");
      virtualObjectShader =
          Shader.createFromAssets(
                  render,
  ...
  /** Change size of object placed on plane  **/
  private void changeSizeObj(HitResult hitResult, MotionEvent motionEvent) {
